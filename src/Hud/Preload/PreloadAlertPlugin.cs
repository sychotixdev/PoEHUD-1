        ...
        private void Parse()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                Dictionary<string, PreloadConfigLine> PerandusLeague = new Dictionary<string, PreloadConfigLine>
                {
                    ...
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss1", new PreloadConfigLine { Text = "Liana, Indebted Peasant", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss2", new PreloadConfigLine { Text = "Marius, Indebted Smuggler", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss3", new PreloadConfigLine { Text = "PerandusGuardSecondaryBoss3", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss4", new PreloadConfigLine { Text = "PerandusGuardSecondaryBoss4", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss5", new PreloadConfigLine { Text = "PerandusGuardSecondaryBoss5", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss6", new PreloadConfigLine { Text = "PerandusGuardSecondaryBoss6", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss7", new PreloadConfigLine { Text = "PerandusGuardSecondaryBoss7", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss8", new PreloadConfigLine { Text = "PerandusGuardSecondaryBoss8", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSecondaryBoss9", new PreloadConfigLine { Text = "PerandusGuardSecondaryBoss9", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSupport1", new PreloadConfigLine { Text = "PerandusGuardSupport1", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSupport2", new PreloadConfigLine { Text = "Marius, Indebted Smuggler", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSupport3", new PreloadConfigLine { Text = "Vera, Indebted Aristocrat", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardSupport4", new PreloadConfigLine { Text = "PerandusGuardSupport4", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardBasic1", new PreloadConfigLine { Text = "Celona, Vault Sentry", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardBasic2", new PreloadConfigLine { Text = "PerandusGuardBasic2", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardBasic3", new PreloadConfigLine { Text = "Hortus, Knee Breaker", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardBasic4", new PreloadConfigLine { Text = "Luthis, Bounty Hunter", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardBasic5", new PreloadConfigLine { Text = "Belatra, Hired Assassin", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardLieutenant1", new PreloadConfigLine { Text = "PerandusGuardLieutenant1", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardLieutenant2", new PreloadConfigLine { Text = "PerandusGuardLieutenant2", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardLieutenant3", new PreloadConfigLine { Text = "PerandusGuardLieutenant3", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardLieutenant4", new PreloadConfigLine { Text = "PerandusGuardLieutenant4", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardLieutenant5", new PreloadConfigLine { Text = "PerandusGuardLieutenant5", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardLieutenant6", new PreloadConfigLine { Text = "PerandusGuardLieutenant6", FastColor = () => Settings.PerandusGuardians }},
                    {"Metadata/Monsters/Perandus/PerandusGuardLieutenant7", new PreloadConfigLine { Text = "Milo Perandus, Handler of Swords", FastColor = () => Settings.PerandusGuardians }},
                };
