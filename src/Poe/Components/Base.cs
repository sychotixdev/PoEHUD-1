...
namespace PoeHUD.Poe.EntityComponents
{
	...
	public class Base : Component
	{
		...
		public string Name
		{
			get
			{
				return M.ReadStringU(M.ReadInt(Address + 0x10, 0x18), 256);
			}
		}
...
namespace PoeHUD.Poe.Components
{
	public class Base : Component
	{
		...
		public string Name
		{
			get
			{
				return M.ReadStringU(M.ReadInt(Address + 0x8, 0x10), 256);
			}
		}

		public int ItemCellsSizeX => M.ReadInt(Address + 0x8, 0x10);
		public int ItemCellsSizeY => M.ReadInt(Address + 0x8, 0x14);
		public bool isCorrupted => M.ReadByte(Address + 0x80) == 1;
		public bool isShaper => M.ReadByte(Address + 0x81) == 1;
		public bool isElder => M.ReadByte(Address + 0x82) == 1;
