namespace PoeHUD.Poe.Elements
{
    ...
    {
        public float ShiftX => M.ReadFloat(M.ReadLong(Address + 0x248 + OffsetBuffers) + OffsetBuffers + 0x1D0);
        public float ShiftY => M.ReadFloat(M.ReadLong(Address + 0x248 + OffsetBuffers) + OffsetBuffers + 0x1D4);
