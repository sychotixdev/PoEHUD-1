...
namespace PoeHUD.Poe.Elements
{
    public class InventoryItemIcon : Element
    {
        ...
        public InventoryItemIcon()
        {
            ...
            inventoryItemTooltip = () => ReadObject<Element>(Address + 0xA68);
            ...
            get
            {
                switch (ToolTipType)
                {
                    case ToolTipType.ItemOnGround:
                        ...
                        ItemsOnGroundLabelElement le = Game.IngameState.IngameUi.ReadObjectAt<ItemsOnGroundLabelElement>(0xACC);
                        if (le == null)
                            return null;
                        Entity e = le.ReadObjectAt<Entity>(OffsetBuffers + 0x244);
                        if (e == null)
                            return null;
