    ...
    public class Offsets
    {
        ...
        */
		...
		private static readonly Pattern fileRootPattern = new Pattern(new byte[]
        {
            ...
            0x48, 0x8b, 0x08,
            0x48, 0x8d, 0x35, 0x39, 0x5f, 0x33, 0x01,

            0x41, 0x8b, 0x04, 0x0e,
            0x39, 0x05, 0x27, 0x5f, 0x33, 0x01,
            0x0f, 0x8e, 0xbf, 0x01, 0x00, 0x00,
            0x48, 0x8d, 0x0d, 0x1a, 0x5f, 0x33, 0x01
        }, "x?x???????x??x??????x??x?????xx?????x?????");
        ...
        */
        ...
        private static readonly Pattern areaChangePattern = new Pattern(new byte[]
        {
            ...
            0x48, 0x85, 0xff,
            0x74, 0x15
        }, "xx??x?????x???x????x???x??x???x?x??????xxx??x?????x???x???x????x?x?");
