...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
    public class Camera : RemoteMemoryObject
    {
        ...
        public float ZFar => M.ReadFloat(Address + 0x1DC);
        public Vector3 Position => new Vector3(M.ReadFloat(Address + 0x104), M.ReadFloat(Address + 0x108), M.ReadFloat(Address + 0x10C));
