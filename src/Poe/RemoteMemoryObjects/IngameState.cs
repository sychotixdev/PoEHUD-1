...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
    ...
    {
        public Camera Camera => GetObject<Camera>(Address + 0x16F4 + Offsets.IgsOffsetDelta);
        ...
        public Element UIRoot => ReadObjectAt<Element>(0xC70 + Offsets.IgsOffset);
        ...
        public long EntityLabelMap => M.ReadLong(Address + 0x90, 0xA40);
        public DiagnosticInfoType DiagnosticInfoType => (DiagnosticInfoType)M.ReadInt(Address + 0xD28 + Offsets.IgsOffset);
        public DiagnosticElement LatencyRectangle => GetObjectAt<DiagnosticElement>(0xF58 + Offsets.IgsOffset);
        public DiagnosticElement FrameTimeRectangle => GetObjectAt<DiagnosticElement>(0x13E8 + Offsets.IgsOffset);
        public DiagnosticElement FPSRectangle => GetObjectAt<DiagnosticElement>(0x1630 + Offsets.IgsOffset);
        ...
        public TimeSpan TimeInGame => TimeSpan.FromSeconds(M.ReadFloat(Address + 0xD0c + Offsets.IgsOffset));
        public float TimeInGameF => M.ReadFloat(Address + 0xD10 + Offsets.IgsOffset);
    }
}