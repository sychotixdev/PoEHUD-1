...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
    public class IngameState : RemoteMemoryObject
    {
        ...
        public float CurLatency => M.ReadFloat(Address + 0xC90 + Offsets.IgsOffset);
        public float CurFrameTime => M.ReadFloat(Address + 0x10E0 + Offsets.IgsOffset);
        public float CurFps => M.ReadFloat(Address + 0x1308 + Offsets.IgsOffset);
