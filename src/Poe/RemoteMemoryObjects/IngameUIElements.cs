...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
	...
	{
		public SkillBarElement SkillBar => ReadObjectAt<SkillBarElement>(0xB68);
		public SkillBarElement HiddenSkillBar => ReadObjectAt<SkillBarElement>(0xB60);
		public PoeChatElement ChatBox => GetObject<PoeChatElement>(M.ReadLong(Address + 0xBE8, 0xAB8, 0xC30)); //TODO: fix offset
		public Element QuestTracker => ReadObjectAt<Element>(0xC70);
		public Element OpenLeftPanel => ReadObjectAt<Element>(0xCD0);
		public Element OpenRightPanel => ReadObjectAt<Element>(0xCD8);
		public InventoryElement InventoryPanel => ReadObjectAt<InventoryElement>(0xD08);
		public Element TreePanel => ReadObjectAt<Element>(0xD38);
		public Element AtlasPanel => ReadObjectAt<Element>(0xD40);
		public Map Map => ReadObjectAt<Map>(0xD98);
		public IEnumerable<ItemsOnGroundLabelElement> ItemsOnGroundLabels
		{
			get
			{
				var itemsOnGroundLabelRoot = ReadObjectAt<ItemsOnGroundLabelElement>(0xDA0);
				return itemsOnGroundLabelRoot.Children;
			}
		}
		public Element GemLvlUpPanel => ReadObjectAt<Element>(0x1098);
		public ItemOnGroundTooltip ItemOnGroundTooltip => ReadObjectAt<ItemOnGroundTooltip>(0x1118);
		...
		public List<Tuple<Quest, int>> GetUncompletedQuests
		{
			get
			{
				var stateListPres = M.ReadDoublePointerIntList(M.ReadLong(Address + 0xA00));
